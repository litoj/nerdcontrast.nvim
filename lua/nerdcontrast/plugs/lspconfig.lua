...
return {
	...
	DiagnosticVirtualTextHint = {fg = "Fg4", italic = true},
	DiagnosticVirtualTextInfo = {fg = "Fg4", italic = true},
	DiagnosticVirtualTextOk = {fg = "Fg4", italic = true},
	DiagnosticUnderlineError = {sp = "Red", undercurl = true},
	DiagnosticUnderlineWarn = {sp = "Orange", undercurl = true},
	DiagnosticUnderlineHint = {sp = "Fg4", underline = true},
	DiagnosticUnderlineInfo = {sp = "Fg4", undercurl = true},
	DiagnosticError = "Red",
