...
return {
	...
	LspReferenceRead = { bg = 'BgGreen', fg = 'FgGreen', bold = true },
	LspReferenceText = { bg = 'BgMagenta', fg = 'FgMagenta', bold = true }, -- functions
	LspReferenceWrite = { bg = 'BgRed', fg = 'FgRed', bold = true },
	...
	['@lsp.mod.modification'] = '@lsp.type.typeParameter', -- lua generics
	...
	['@lsp.typemod.variable.global'] = '@namespace',
